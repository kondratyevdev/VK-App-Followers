...
function PlaceSelect(input, container, options) {
  ...
  function getURL() {
    return URL + '/select_ajax.php?act=a_get_places&' + (options.street ? ('streets=' + options.street) : ('city=' + options.city));
  }
...
function HouseSelect(input, container, options) {
  ...
  options = extend(defaults, options);
  options.enableCustom = (options.forceEnableCustom >= 0);
  var selector = new Selector(input, URL + '/select_ajax.php?act=a_get_houses&streets=' + options.street, options);
  ...
  function streetUpdated() {
    selector.setURL(URL + '/select_ajax.php?act=a_get_houses&streets=' + options.street);
...
function StreetSelect(input, container, options) {
  ...
  var selector = new Selector(input, URL + '/select_ajax.php?act=a_get_streets&city=' + options.city, options);
  ...
  function cityUpdated(ignoreChildren) {
    selector.clear();
    selector.setURL(URL + '/select_ajax.php?act=a_get_streets&city=' + options.city);
    if (!ignoreChildren) {
      zeroChildren();
    }
    if (options.city) {
...
function SchoolHintSelect(input, container, options) {
  ...
  options.school = intval(options.school);
  options.enableCustom = (options.forceEnableCustom > 0);
  var selector = new Selector(input, URL + '/select_ajax.php?act=a_get_schools&city=' + options.city, options);
  ...
  function cityUpdated() {
    selector.clear();
    selector.setURL(URL + '/select_ajax.php?act=a_get_schools&city=' + options.city);
    if (options.city) {
      selectsData.getCityInfo(options.city, 4, function(cityInfo) {
        options.items_count = cityInfo.schools.length;
        var new_options = {
...
function UniversityHintSelect(input, container, options) {
  ...
  options.city = intval(options.city);
  options.enableCustom = (options.forceEnableCustom > 0);
  var selector = new Selector(input, URL + '/select_ajax.php?act=a_get_universities&country=' + options.country + '&city=' + options.city, options);
  ...
  function countryUpdated(ignoreChildren) {
    selector.clear();
    selector.setURL(URL + '/select_ajax.php?act=a_get_universities&country=' + options.country);
    if (!ignoreChildren) {
      zeroChildren();
    }
  ...
  function cityUpdated(ignoreChildren) {
    selector.clear();
    selector.setURL(URL + '/select_ajax.php?act=a_get_universities&country=' + options.country + '&city=' + options.city);
    if (!ignoreChildren) {
      zeroChildren();
    }
    if (options.city) {
...
function CitySelect(input, container, options) {
  ...
  options.country = intval(options.country);
  var selector = new Selector(input, URL + '/select_ajax.php?act=a_get_cities&country=' + options.country, options);
  ...
  function countryUpdated(ignoreChildren) {
    selector.clear();
    selector.setURL(URL + '/select_ajax.php?act=a_get_cities&country=' + options.country);
    if (!ignoreChildren) {
      zeroChildren();
    }
    if (options.country) {
